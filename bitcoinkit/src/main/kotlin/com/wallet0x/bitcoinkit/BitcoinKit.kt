package com.wallet0x.bitcoinkit
...
import com.wallet0x.bitcoincore.blocks.validators.*
...
import com.wallet0x.bitcoinkit.BitcoinKit.Listener
import com.wallet0x.bitcoinkit.BitcoinKit.NetworkType
import com.wallet0x.hdwalletkit.*
...
class BitcoinKit : AbstractKit {
    ...
    private fun apiTransactionProvider(
        ...
        NetworkType.TestNet -> {
            com.wallet0x.bitcoincore.apisync.BCoinApi("https://btc-testnet.blocksdecoded.com/api")
        }
