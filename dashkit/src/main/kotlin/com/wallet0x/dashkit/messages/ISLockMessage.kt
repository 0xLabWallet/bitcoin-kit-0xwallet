...
class ISLockMessage(
    val inputs: List<com.wallet0x.dashkit.messages.Outpoint>,
...
class ISLockMessageParser : IMessageParser {
    ...
    override fun parseMessage(input: BitcoinInputMarkable): IMessage {
        ...
        val inputs = List(inputsSize.toInt()) {
            com.wallet0x.dashkit.messages.Outpoint(input)
        }
        ...
        return com.wallet0x.dashkit.messages.ISLockMessage(inputs, txHash, sign, hash, requestId)
    }
}
