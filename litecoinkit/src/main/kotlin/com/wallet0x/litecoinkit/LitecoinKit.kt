...
import com.wallet0x.bitcoincore.blocks.validators.BitsValidator
...
import com.wallet0x.bitcoincore.blocks.validators.LegacyTestNetDifficultyValidator
...
import com.wallet0x.bitcoincore.managers.Bip49RestoreKeyConverter
import com.wallet0x.bitcoincore.managers.BlockValidatorHelper
import com.wallet0x.bitcoincore.managers.KeyHashRestoreKeyConverter
...
import com.wallet0x.litecoinkit.validators.LegacyDifficultyAdjustmentValidator
import com.wallet0x.litecoinkit.validators.ProofOfWorkValidator
...
class LitecoinKit : AbstractKit {
    ...
    private fun bitcoinCore(
        ...
        val database = com.wallet0x.bitcoincore.storage.CoreDatabase.getInstance(context, getDatabaseName(networkType, walletId, syncMode, purpose))
    ...
    private fun apiTransactionProvider(
        ...
        NetworkType.MainNet -> {
            val bCoinApiProvider =
                com.wallet0x.bitcoincore.apisync.BCoinApi("https://ltc.blocksdecoded.com/api")
        ...
        NetworkType.TestNet -> {
            com.wallet0x.bitcoincore.apisync.BCoinApi("")
        }
    }
